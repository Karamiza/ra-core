...
import { CRUD_GET_LIST_SUCCESS, CRUD_CREATE_SUCCESS, CRUD_DELETE_SUCCESS, } from '../../../../actions';
...
var idsReducer = function (previousState, action) {
    ...
    switch (action.type) {
        ...
        case CRUD_DELETE_SUCCESS:
            return previousState.filter(function (id) { return action.requestPayload.id !== id; });
        // end modif JB
